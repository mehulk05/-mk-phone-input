...
@Component({
  selector: 'lib-ng-intl-tel-input',
  standalone: false,
  templateUrl:'./ng-intl-tel-input.component.html',
  styleUrls: ['ng-intl-tel-input.component.css', './bootstrap-dropdown.css'],
  providers: [
		CountryCode,
		{
			provide: NG_VALUE_ACCESSOR,
			// tslint:disable-next-line:no-forward-ref
			useExisting: forwardRef(() => NgIntlTelInputComponent),
			multi: true,
		},
		{
...
export class NgIntlTelInputComponent implements OnInit, OnChanges {
