...
import { phoneNumberValidator } from './ng-international-tel-input.validator';

@Component({
  selector: 'lib-ng-international-tel-input',
  standalone: false,
  
  templateUrl: './ng-international-tel-input.component.html',

  styleUrls: ['./ng-international-tel-input.component.css', './bootstrap-dropdown.css'],
    providers: [
      CountryCode,
      {
        provide: NG_VALUE_ACCESSOR,
        // tslint:disable-next-line:no-forward-ref
        useExisting: forwardRef(() => NgInternationalTelInputComponent),
        multi: true,
      },
      {
...
export class NgInternationalTelInputComponent implements OnInit, OnChanges {
  ...
  */
  ...
  public onPhoneNumberChange(): void {
    ...
    if (!this.value) {
      ...
      console.log(this.phoneNumber, this.phoneUtil);
      if(this.phoneNumber.length > 3){
        this.phoneNumber =  this.phoneUtil?.format(number, lpn.PhoneNumberFormat.NATIONAL) ||  this.phoneNumber;
      }
    }
  }
  ...
  public onCountrySelect(country: Country, el: { focus: () => void; }): void {
    ...
    if (this.phoneNumber && this.phoneNumber.length > 0) {
      ...
      if(this.phoneNumber.length > 3){
        this.phoneNumber =  this.phoneUtil?.format(intlNo, lpn.PhoneNumberFormat.NATIONAL) ||  this.phoneNumber;
      }
